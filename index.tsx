        ...
        <section style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", padding: "14px", borderRadius: "10px", border: "1px solid var(--background-modifier-accent)" }}>
                ...
                <Paragraph style={{ margin: 0, color: "var(--text-muted)", fontSize: "13px" }}>
                    Otimizar rota = escolhe o melhor servidor Proton e reinicia o Discord (precisa ser feito pelo menos 1 vez apos o login).
                </Paragraph>
...
function pollStreamClaimOnce() {
    ...
    if (decision.warn) {
        ...
        showToast(
            "Lefferzin Bypass: Discord diz que você está transmitindo, mas nenhuma conexão Live apareceu em 30s (possível erro 2001). Pare a transmissão falsa, recarregue com Ctrl+R e tente de novo.",
            Toasts.Type.FAILURE
        );
